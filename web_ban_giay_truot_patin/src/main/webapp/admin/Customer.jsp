...
<body>
    ...
    <nav class="navbar navbar-default">
        <div class="container">
            ...
            <li class="active"><a href="Customer.jsp">Quản lý khách hàng</a></li>
    ...
    <section id="main">
        <div class="container">
            <div class="row">
              ...
              <a href="Customer.jsp" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Quản lý khách hàng <span class="badge">8</span></a>
