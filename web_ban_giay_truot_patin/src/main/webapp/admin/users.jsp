                ...
                <table class="table table-striped table-hover">
                  <a href="user_add.jsp"> <button id="btn_them_user">Thêm tài khoản mới</button></a>
                      ...
                      <tr>
                        ...
                        <td>10-11-2016</td>                       
                        <th>Admin</th>
                        <td><a class="btn btn-default" class="list-group-item" href="user_add.jsp"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a> <a class="btn btn-danger" class="list-group-item"
