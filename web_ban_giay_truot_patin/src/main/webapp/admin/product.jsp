...
<body>
        ...
        <div class="container">
            ...
            <div id="navbar" class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="product.jsp">Quản lý sản phẩm</a></li>
    ...
    <section id="breadcrumb">
        <div class="container">
            <ol class="breadcrumb">
                <li><a href="index.jsp"> Trang quảng trị</a></li>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="list-group">
                        ...
                        <a href="product.jsp" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> Quản lý sản phẩm <span class="badge">6</span></a>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <table class="table table-striped table-hover">
                                <a href="blog_add.jsp"> <button id="btn_them_post">Thêm sản phẩm mới</button></a>
                                ...
                                <tr>
                                    <td>01</td>
                                    <td>PT-205</td>
                                    <td><img src="image/sp1.jpg" style="width: 50px;height: 50px;">
                                    </td>
                                    <td>GIÀY PATIN FLYING EAGLE BKB K8</td>
                                    <td>PT_1</td>
                                    <td><a class="btn btn-default" class="list-group-item" href="product_add.jsp"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a> <a class="btn btn-danger" class="list-group-item"
                                                                                                                                                                                             href="#"><span class="glyphicon glyphicon-trash"></span></a></td>                                </tr>
                                <tr>
                                    <td>02</td>
                                    <td>PT-276</td>
                                    <td><img src="image/sp2.jpg" style="width: 50px;height: 50px;">
                                    </td>
                                ...
                                <tr>
                                    <td>03</td>
                                    <td>PT-A52</td>
                                    <td><img src="image/sp3.jpg" style="width: 50px;height: 50px;">
                                    </td>
                                ...
                                <tr>
                                    <td>04</td>
                                    <td>BH-01</td>
                                    <td><img src="image/sp4.jpg" style="width: 50px;height: 50px;">
                                    </td>
                                ...
                                <tr>
                                    <td>05</td>
                                    <td>FE-1</td>
                                    <td><img src="image/sp5.jpg" style="width: 50px;height: 50px;">
                                    </td>
                                ...
                                <tr>
                                    <td>06</td>
                                    <td>BX-1</td>
                                    <td><img src="image/sp6.jpg" style="width: 50px;height: 50px;">
                                    </td>
