      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="posts.jsp">Quản lý bài viết</a></li>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="posts.jsp" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Quản lý bài viết <span class="badge">6</span></a>
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <a href="product_add.jsp"> <button id="btn_them_post">Thêm bài viết mới</button></a>
                  ...
                  <tr>
                      ...
                      <td><a class="btn btn-default" class="list-group-item" href="blog_add.jsp"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a> <a class="btn btn-danger" class="list-group-item"
